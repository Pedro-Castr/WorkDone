...
<body>
    ...
    <main>
        <h1>Cadasto de Tarefas</h1>

        <hr class="my-2">

        <div class="row mx-2">
            <div class="col-7">
                <label for="descricao" class="form-label">Nome da Tarefa</label>
                <input type="text" class="form-control" id="descricao" name="descricao" placeholder="Nome da sua Tarefa" required autofocus>
            </div>
